...
urlpatterns = [
    ...
    path('accounts/admin-signup/', AdminSignupView.as_view(), name='accounts_admin_signup'),
    path('auth/admin-verify-signup-otp/', AdminVerifySignupOTPView.as_view(), name='auth_admin_verify_signup_otp'),
    path('accounts/admin-verify-signup-otp/', AdminVerifySignupOTPView.as_view(), name='accounts_admin_verify_signup_otp'),
    path('auth/resend-signup-otp/', ResendSignupOTPView.as_view(), name='auth_resend_signup_otp'),
    path('accounts/resend-signup-otp/', ResendSignupOTPView.as_view(), name='accounts_resend_signup_otp'),
